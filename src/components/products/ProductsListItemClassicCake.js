...
import cakeOptions from '../../server/classiccake.json';
...
class ProductsListItemClassicCake extends Component {
    ...
    return (
      <div>
        ...
        <div className="item--header">
          <div><h2>{this.state.selectedProduct.productName} {this.state.selectedProduct.type === 'classiccake'?'Cake':''}</h2><p className="desc-cake">{opt.name}</p></div>
...
export default connect(undefined, mapDispatchToProps)(ProductsListItemClassicCake);
